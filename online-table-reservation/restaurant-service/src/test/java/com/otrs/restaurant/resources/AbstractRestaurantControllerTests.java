...
public abstract class AbstractRestaurantControllerTests {
    ...
    public void validResturantById() {
        ...
        ResponseEntity<Restaurant> restaurant = restaurantController.findById(RESTAURANT);
    ...
    public void validResturantByName() {
        ...
        ResponseEntity<Restaurant> restaurants = restaurantController.findByName(RESTAURANT_NAME);
        ...
        Restaurant restaurant = (Restaurant) restaurants.getBody();
